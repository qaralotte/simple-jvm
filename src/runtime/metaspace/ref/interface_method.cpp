...
InterfaceMethodRef::InterfaceMethodRef(ConstantPool *rconstant_pool, const vector<shared_ptr<classfile::cp_info>> &cconstant_pool, shared_ptr<classfile::InterfaceMethodref> info) {
